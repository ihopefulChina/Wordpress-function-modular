...
class Code_Snippets_Admin {
	...
	function mu_menu_items( $menu_items ) {
		$menu_items['snippets'] = __( '函数模块化', 'code-snippets' );
		$menu_items['snippets_settings'] = __( '函数模块化 &raquo; 设置', 'code-snippets' );
	...
	function plugin_settings_link( $links ) {
		array_unshift( $links, sprintf(
			...
			__( '管理您现有的函数模块化代码', 'code-snippets' ),
			__( '函数模块化', 'code-snippets' )
		) );
